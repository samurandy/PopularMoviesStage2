...
import com.example.android.popularmoviesstage2.DbUtils.HelpFavorite;
...
import com.example.android.popularmoviesstage2.DbUtils.MovieContracts;
...
public class DetailActivityFragment extends Fragment {
    ...
    @Bind(R.id.detail_reviews_cardView)
    CardView mReviewsCardView;
    @Bind(R.id.detail_trailers_cardView)
        ...
        if (mMovie != null) {
            ...
            new AsyncTask<Void, Void, Integer>() {
                ...
                protected Integer doInBackground(Void... params) {
                    return HelpFavorite.isFavorite(mContext, mMovie.getId());
                }
                            ...
                            if (isFavorite == 1) {
                                ...
                                new AsyncTask<Void, Void, Uri>() {
                                    ...
                                    protected Uri doInBackground(Void... params) {
                                        ...
                                        values.put(MovieContracts.MovieEntry.COLUMN_MOVIE_ID, mMovie.getId());
                                        values.put(MovieContracts.MovieEntry.COLUMN_TITLE, mMovie.getTitle());
                                        values.put(MovieContracts.MovieEntry.COLUMN_POSTER, mMovie.getPoster());
                                        values.put(MovieContracts.MovieEntry.COLUMN_BACKDROP, mMovie.getBackdrop());
                                        values.put(MovieContracts.MovieEntry.COLUMN_OVERVIEW, mMovie.getOverview());
                                        values.put(MovieContracts.MovieEntry.COLUMN_RATING, mMovie.getRating());
                                        values.put(MovieContracts.MovieEntry.COLUMN_DATE, mMovie.getDate());

                                        return getActivity().getContentResolver().insert(MovieContracts.MovieEntry.CONTENT_URI,
                                                values);
                                    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
            ...
            String image_url = HelpFavorite.buildImageUrl(342, mMovie.getBackdrop());
